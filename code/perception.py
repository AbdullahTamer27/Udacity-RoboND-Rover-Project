...
def perception_step(Rover):
    ...
    dst_size = 3
    bottom_offset = 5
    source = np.float32([[14, 175], [300 ,175],[210, 105], [125, 105]])
    ...
    Rover.vision_image[:,:,0] = color_thresh(warped)*200
    Rover.vision_image[:,:,2] = find_obstacle(warped) *200
    Rover.vision_image[:,:,1] = find_rock(warped)*200
